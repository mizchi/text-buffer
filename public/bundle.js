...
/***/ function(module, exports, __webpack_require__) {
	...
	var Document, React, TextBuffer, charFromKeyEvent;

	React = __webpack_require__(3);

	charFromKeyEvent = __webpack_require__(1);

	Document = __webpack_require__(2);

	TextBuffer = React.createClass({
	  onKeyDown: function(ev) {
	    var char, display;
	    ev.preventDefault();
	    display = this.refs.display.getDOMNode();
	    char = charFromKeyEvent(ev);
	    this.state.doc.handleInput({
	      char: char,
	      shift: ev.shiftKey,
	      alt: ev.altKey,
	      meta: ev.metaKey,
	  ...
	  render: function() {
	    var $, char, charCount, cursor, line, lineCount;
	    $ = React.createElement;
	    return $('div', {
	      ref: 'textBuffer',
	      onClick: this.focus,
	      ...
	      $('div', {
	        ...
	        $('div', {
	          ...
	          _ref = this.state.body.split('\n');
	          _results = [];
	          for (lineCount = _i = 0, _len = _ref.length; _i < _len; lineCount = ++_i) {
	            line = _ref[lineCount];
	            _results.push($('div', {
	              key: 'l:' + lineCount,
	              className: 'line'
	              ...
	              if (line.length > 0) {
	                _ref1 = line.split('');
	                _results1 = [];
	                for (charCount = _j = 0, _len1 = _ref1.length; _j < _len1; charCount = ++_j) {
	                  char = _ref1[charCount];
	                  cursor = this.state.doc.cursor;
	                  _results1.push($('span', {
	                    key: lineCount + ':' + charCount,
	                    className: 'char',
	                    style: {
	                      backgroundColor: cursor.ch - 1 === charCount && cursor.line === lineCount ? 'green' : 'transparent'
	                    }
	                  }, char));
	                }
	                return _results1;
	...
	window.addEventListener('load', (function(_this) {
	  return function() {
	    return React.render(React.createFactory(TextBuffer)({}), document.body);
	  };
	})(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getInputFromKeyEventEvent;

	module.exports = getInputFromKeyEventEvent = (function() {
	  var i, _KEYCODE_MAP, _MAP, _SHIFT_MAP, _SPECIAL_ALIASES, _i, _j;
	  _MAP = {
	    8: 'backspace',
	    9: 'tab',
	    13: 'enter',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Document, Position;

	Position = (function() {
	  function Position(_at_line, _at_ch) {
	    this.line = _at_line != null ? _at_line : 0;
	    this.ch = _at_ch != null ? _at_ch : 0;
	  }
	...
	module.exports = Document = (function() {
	  ...
	  Document.prototype.insertText = function(text, pos) {
	    console.log('insert', text, pos);
	    return this.text = this.text.split('\n').map((function(_this) {
	      return function(line, lineCount) {
	        if (lineCount === pos.line) {
	          return line.slice(0, pos.ch) + text + line.slice(pos.ch);
	        } else {
	          return line;
	        }
	      };
	  ...
	  Document.prototype.deletePosition = function(pos) {
	    return this.text = this.text.split('\n').map((function(_this) {
	      return function(line, lineCount) {
	        if (lineCount === pos.line) {
	          return line.slice(0, pos.ch - 1) + line.slice(pos.ch);
	        } else {
	          return line;
	        }
	      };
	  ...
	  Document.prototype.moveForward = function() {
	    return this.cursor.ch += 1;
	  };

	  Document.prototype.moveBackward = function() {
	    return this.cursor.ch -= 1;
	  };

	  Document.prototype.moveNextLine = function() {
	    return this.cursor.line += 1;
	  };

	  Document.prototype.movePreviousLine = function() {
	    return this.cursor.line -= 1;
	  };

	  Document.prototype.handleInput = function(input) {
	    var _ref;
	    if (input.char === 'backspace') {
	      this.deletePosition(this.cursor);
	      if (this.cursor.ch >= 0) {
	        return this.cursor.ch--;
	      } else {
	        return this.cursor.line--;
	      }
	    } else if (input.char === 'enter') {
	      this.text += '\n';
	      this.cursor.ch = 0;
	      return this.cursor.line++;
	    } else if (input.char === 'space') {
	      this.text += ' ';
	      return this.cursor.ch++;
	    } else if ((_ref = input.char) === 'right' || _ref === 'up' || _ref === 'down' || _ref === 'left') {
	      switch (input.char) {
	        case 'right':
	        ...
	        case 'up':
	          return this.movePreviousLine();
	        case 'down':
	          return this.moveNextLine();
	      }
	    } else {
	      if (/[a-zA-Z ]/.test(input.char)) {
	        this.insertText(input.char, this.cursor);
	        return this.cursor.ch++;
	      }
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(154);
	var getMarkupWrap = __webpack_require__(152);
	var invariant = __webpack_require__(34);
